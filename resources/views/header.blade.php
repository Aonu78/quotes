        ...
        <div class=page-content fbs-breakpoint-monitor>
            <div class="page-container clearfix">
                <div class="layout clearfix">
                    <div id="menu1" class="left-section scroll left-div">
                                ...
                                <li>
                                    ...
                                    <ul class="two-cols clearfix">
                                        @foreach($category as $item)
                                            <li class=><a class='' onclick="mynavfunc()" href="/category/{{$item->name}}">{{$item->name}}</a>  {{--  --}}
                                        @endforeach
                                    </ul>
                            </ul>
                        </nav>
                                ...
                                <li>
                                    ...
                                    <ul class="two-cols clearfix">
                                        @foreach($artists as $author)
                                            <li class=><a class='' onclick="mynavrfunc()" href="/author/{{$author->name}}">{{$author->name}}</a>  {{--  --}}
                                        @endforeach
                                    </ul>
                            </ul>
                        </nav>
                    ...
                    <div id="mynav" class="right-section anim">
                        <header class=>
                            ...
                            <a class="">                                
                                <em class="fa-solid fa-bars icn quotes-menu" onclick="mynavfunc()"></em>
                            </a>
...
a:hover > span { visibility: visible; opacity: 0.7;transition: visibility 0s, opacity 0.5s linear;}
                            ...
                            <a class="home-lnk ">                                
                                <em class="fa-solid fa-bars icn quotes-home" onclick="mynavrfunc()"></em><span class="home-title sf-hidden">Home.com</span>
                            </a>
                            <a href="/" class="home-lnk ">                                
                                <em class="fa-solid fa-house icn quotes-home"></em><span class="home-title sf-hidden">Home.com</span>
                            </a>
                            
                            {{-- <i class="fa-solid fa-bars icn home-lnk" onclick="mynavfunc()"></i> --}}
