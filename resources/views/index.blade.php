    ...
    <blockquote class="bubble ">
        ...
        <div class=socialize gigya-sharing data-showprefix=true>
            <div class=social-icons>
                ...
                <span class="share">Share</span> 
                <a href="http://www.facebook.com/sharer.php?u={{url('')}}/category/{{$feature}}/{{$mainquote->id}}&p[title]={{$mainquote->quote}}"><i class="fa-brands fa-facebook icn" style="color: white;"></i></a>                            
                <a href="http://twitter.com/share?text={{$mainquote->quote}}&url={{url('')}}/category/{{$feature}}/{{$mainquote->id}}"><i class="icon-advanced-white icn" style="color: white;fill: white;"></i></a> 
                <a href="https://www.instagram.com/shareArticle/?mini=true&url={{url('')}}/category/{{$feature}}/{{$mainquote->id}}&title={{$mainquote->quote}}"><i class="fa-brands fa-instagram icn" style="color: white;"></i></a> 
                <a href="https://api.whatsapp.com/send?text={{$mainquote->quote}}"><i class="fa-brands fa-whatsapp icn" style="color: white;"></i></a>
                <a href="https://vk.com/share.php?url={{url('')}}/category/{{$feature}}/{{$mainquote->id}}&title={{$mainquote->quote}}"><i class="fa-brands fa-vk icn" style="color: white;"></i></a>
